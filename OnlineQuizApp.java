...
public class OnlineQuizApp {
    public static void main(String[] args) {
        ...
        Question question2 = new Question("Which planet is known as the Red Planet?",
                new String[]{"A. Mars", "B. Jupiter", "C. Saturn", "D. Earth"}, 0);
        ...
        Question question4 = new Question("Who painted the Mona Lisa?",
                new String[]{"A. Leonardo da Vinci", "B. Vincent van Gogh", "C. Pablo Picasso", "D. Michelangelo"}, 0);
        Question question5 = new Question("What is the largest ocean in the world?",
                new String[]{"A. Pacific Ocean", "B. Indian Ocean", "C. Atlantic Ocean", "D. Arctic Ocean"}, 0);
